...
using DurableFunction_Exemplos.Model;
...
namespace DurableFunction_Exemplos
{
    public static class HumanInteraction
    {
            ...
            ILogger log)
        {
            try
            {
                ...
                string instanceId = await starter.StartNewAsync("HumanPatternExample_Orchestrator", null, (descontoRequest, requestUri: req.RequestUri));
        ...
        public static async Task RunOrchestrator([OrchestrationTrigger] IDurableOrchestrationContext context, ILogger log)
        {
            ...
            {
                DateTime moderationDeadline = context.CurrentUtcDateTime.AddMinutes(10);
